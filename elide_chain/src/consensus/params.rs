...
const _: () = assert!(
    TX_EPOCH_BLOCKS == elide_tx::TX_EPOCH_BLOCKS,
    "elide_chain TX_EPOCH_BLOCKS must equal elide_tx"
);
...
// Slot allocator PRNG
// ---------------------------------------------------------------------------
// splitmix64 constants are embedded in elide_chain::consensus::allocator.
