...
pub const MAX_AUTHORIZATION_BYTES: usize = elide_tx::MAX_TX_AUTHORIZATION_BYTES;
pub const MAX_TX_INTENT_BYTES_GLOBAL: usize = elide_tx::MAX_PAGED_SPEND_INTENT_BYTES;
...
pub const MAX_BLOCK_BYTES: usize =
    1 + crate::wire::BLOCK_HEADER_WIRE_SIZE + 4 + 256 * elide_tx::TX_BODY_WIRE_SIZE;
...
mod tests {
    ...
    fn final_wire_caps_match_canonical_constructions() {
        assert_eq!(MAX_AUTHORIZATION_BYTES, elide_tx::MAX_TX_AUTHORIZATION_BYTES);
        assert_eq!(
            MAX_TX_INTENT_BYTES_GLOBAL,
            elide_tx::MAX_PAGED_SPEND_INTENT_BYTES
        );
