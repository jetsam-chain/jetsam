...
use elide_poseidon2b::primitives::{Address, Digest};
use elide_tx::{PagedSpendFacts, Transaction};
...
fn build_block_template_with_post_state(
    ...
    use elide_tx::{TxBody, TxInput, TxOutput, TX_INPUTS};
    ...
    let development_payout = allocation.payout_each.map(|amount| {
        ...
        Transaction::new(TxBody {
            ...
            validity_bitmap: elide_tx::output_bitmap_bit(0) | elide_tx::output_bitmap_bit(1),
            is_coinbase: true,
        })
    });
