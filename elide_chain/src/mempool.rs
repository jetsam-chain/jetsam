...
//! `AsyncMempool` in `elide_mempool` wraps this in async admission/eviction tasks and connects it to the
//! P2P layer and the block template builder.
//!
//! # Design
//!
//! Admission and authorization run in `elide_mempool`; this module only owns
...
impl MempoolEntry {
    ...
    pub fn new(pages: Vec<TxPage>, current_height: u64) -> Result<Self, elide_tx::PagedSpendError> {
