...
use elide_poseidon2b::native::compression::{compress_with_tag, Poseidon2bSponge};
use elide_poseidon2b::native::domain::{capacity_iv, TAG_EXSTNOD, TAG_EXSTSLT};
...
mod tests {
    ...
    /// `cargo test --release -p elide_chain --lib print_zero_root_golden -- --ignored --nocapture`
    #[test]
    #[ignore]
