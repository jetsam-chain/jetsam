...
use elide_tx::{pack_amount_creation_id, unpack_amount_creation_id};
...
use elide_fri::channel::Channel;
use elide_fri_binius::{
...
/// (see `elide_tx::public::PublicInputs::log_slots` and `MAX_LOG_SLOTS`),
...
///
/// Uses the compact `elide_fri_binius` interleaved commitment scheme for local
...
impl FriState {
    ...
    ///
    /// Uses `elide_fri_binius::interleaved_commit` over the three columns,
...
pub fn open_segment_at_point(
    ...
    let ntt = elide_core::AdditiveNTT::<Block128>::new(commit_log + elide_fri::code::LOG_RATE);
...
const MIN_COMMIT_LOG: usize = elide_fri_binius::MERKLE_CAP_DEPTH;
...
pub fn cap_to_seg_root(cap: &elide_fri_binius::MerkleCap) -> StateRoot {
...
pub fn cap_to_seg_root_with_depth(cap: &elide_fri_binius::MerkleCap, eff_log: usize) -> StateRoot {
