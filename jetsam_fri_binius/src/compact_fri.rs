...
//!
//! Key differences from the generic `jetsam_fri::prover`:
...
use jetsam_fri::code::{fold, Code, LOG_RATE};
...
///
/// Same protocol as `jetsam_fri::prover::prove` but with COMPACT_TAU and
...
mod path_expansion_tests {
    use super::*;
    use jetsam_poseidon2b::Poseidon2bSponge;
