...
///
/// ```compile_fail
/// use jetsam_fri_binius::ZkCapsulePcsSourceProverState;
///
...
/// use jetsam_fri_binius::{zk_capsule_pcs_bind_phase_a, ZkCapsulePcsSourceProverState};
///
...
/// ```compile_fail
/// use jetsam_core::Block128;
/// use jetsam_fri_binius::{zk_capsule_pcs_commit_mid, ZkCapsulePcsSourceProverState};
///
