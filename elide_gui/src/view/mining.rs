    ...
    let flow = if transaction.development_payout {
        ...
        column![
            ...
            text(format!(
                ...
                format_microelide_string(&transaction.output_sum_micro_eld)
            ))
            .size(13)
            .color(theme::ACCENT),
        ]
        ...
        column![
            ...
            row![
                detail(
                    ...
                    format!(
                        "{} ①",
                        format_microelide_string(&transaction.input_sum_micro_eld)
                    ),
                ),
                detail(
                    "OUTPUT TOTAL",
...
fn format_microelide_string(value: &str) -> String {
