...
pub fn format_microelide_trimmed(value: u64) -> String {
...
mod tests {
    use super::{
        ...
        format_hashrate, format_microelide_trimmed, format_pow_work_change, AppSnapshot,
        SensitiveString,
    };
    ...
    fn trims_only_insignificant_reward_decimals() {
        assert_eq!(format_microelide_trimmed(50_000_000), "50");
        assert_eq!(format_microelide_trimmed(12_500_000), "12.5");
        assert_eq!(format_microelide_trimmed(3_125_000), "3.125");
        assert_eq!(format_microelide_trimmed(1_562_500), "1.5625");
        assert_eq!(format_microelide_trimmed(1_000_001), "1.000001");
    }
