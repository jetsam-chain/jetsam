...
use elide_ivc_core::field_r1cs::{CompactFieldR1cs, synthetic_satisfiable};
use elide_ivc_core::pcs::{self, PcsParams};
use elide_ivc_core::proof::FieldShape;
use elide_ivc_prover::field_prover::{prove_field, prove_field_compact};
...
fn field_proof_byte_digest() {
    ...
    for &(m, k_log, seed) in &[(10usize, 7usize, 1u64), (12, 8, 2), (13, 10, 3)] {
        ...
        let digest =
            elide_poseidon2b::native::poseidon2b_hash_byte_slices(b"BYTE-IDENTITY-PROBE", &[&bytes]);
