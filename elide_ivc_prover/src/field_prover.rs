...
//! `elide_ivc_core::verifier::verify_field`.

use elide_ivc_core::challenger::Challenger;
use elide_ivc_core::field::{F128, F256};
use elide_ivc_core::field_r1cs::{CompactFieldR1cs, FieldProverRelation, FieldR1cs};
use elide_ivc_core::lincheck::{self, LocallyAuthoredFreshLincheckCapture, QuirkyPoint};
use elide_ivc_core::pcs::{self, C1QuirkyDirectClaim, Commitment, PcsParams, QuirkyDirectClaim};
use elide_ivc_core::proof::{
...
/// `elide_ivc_core::public_io`). The witness must hold the envelope lanes in
