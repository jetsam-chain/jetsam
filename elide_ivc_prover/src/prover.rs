...
use elide_ivc_core::lincheck::{self, QuirkyPoint, pack_z_lincheck_from_packed};
use elide_ivc_core::pcs::{self, Commitment, PcsParams};
use elide_ivc_core::proof::{R1csClaim, R1csProof, R1csProofLigerito, ZClaim, bind_statement};
use elide_ivc_core::r1cs::BlockR1cs;
use elide_ivc_core::zerocheck;
...
/// [`elide_ivc_core::verifier::verify_claims`].
...
/// `R1csProofLigerito` instead of `R1csProof`. Same FS protocol prefix
...
pub fn prove_fast_from_witness<Ch: Challenger>(
    ...
    elide_ivc_core::scratch::give_f128(core.z_packed);
...
pub fn prove_fast_core_with_codeword<Ch: Challenger>(
    ...
    elide_ivc_core::scratch::give_f128(a_packed_f128);
    elide_ivc_core::scratch::give_f128(b_packed_f128);
