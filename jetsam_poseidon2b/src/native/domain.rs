...
pub fn capacity_iv_flat(tag: DomainTag) -> [u128; 2] {
    ...
    [
        jetsam_core::hardware::tower_to_flat_u128(high.0),
        jetsam_core::hardware::tower_to_flat_u128(low.0),
    ]
}
...
/// Wallet-capsule FRI transcript (`jetsam_fri::Channel`) and its replays.
