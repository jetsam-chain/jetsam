...
//! [`jetsam_core::transcript::FiatShamir`].
//!
//! This is the *production* transcript for protocols in `jetsam_core` that
...
//! test vectors downstream (notably in `jetsam_fri` prover/verifier and
