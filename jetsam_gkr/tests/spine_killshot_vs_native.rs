...
fn killshot_reductions_consistent_with_native_mle() {
    ...
    assert_eq!(
        jetsam_core::mle::evaluate::evaluate_slice(&mle.state, &reductions.state.point),
        reductions.state.value
    );
    assert_eq!(
        jetsam_core::mle::evaluate::evaluate_slice(&mle.s_in, &reductions.sin.point),
        reductions.sin.value
    );
    assert_eq!(
        jetsam_core::mle::evaluate::evaluate_slice(&mle.s_out, &reductions.sout.point),
