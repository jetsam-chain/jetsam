...
//!
//! ```compile_fail
//! use jetsam_gkr::{prove_owner_auth_killshot, OwnerAuthProofKillShot};
//! ```
//!
//! ```compile_fail
//! use jetsam_gkr::auth_pcs::AuthMleOpeningProof;
//! ```
//!
//! ```compile_fail
//! let _ = jetsam_gkr::ghost_tx::ghost_authorization();
//! ```
