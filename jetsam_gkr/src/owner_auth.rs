...
use jetsam_tx::{canonical_owner_auth, CanonicalOwnerAuth, OwnerAuthError, TxBody};
...
mod tests {
    use super::*;
    use jetsam_poseidon2b::primitives::{derive_address, Address, SpendSecret};
    use jetsam_tx::{output_bitmap_bit, TxInput, TxOutput, TX_INPUTS, TX_OUTPUTS};
