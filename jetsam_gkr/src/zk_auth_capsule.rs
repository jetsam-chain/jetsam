...
use jetsam_core::sumcheck::RoundPolynomial;
...
const _: () =
    assert!(ZK_AUTH_CAPSULE_BANK_VARS == jetsam_fri_binius::zk_affine_code::AFFINE_CODE_MESSAGE_LOG);
const _: () =
    assert!(ZK_AUTH_CAPSULE_BANK_LEN == jetsam_fri_binius::zk_affine_code::AFFINE_CODE_MESSAGE_LEN);
const _: () =
    assert!(ZK_AUTH_CAPSULE_STATE_LEN == jetsam_fri_binius::zk_affine_code::AFFINE_STATE_LEN);
const _: () = assert!(
    ZK_AUTH_CAPSULE_PCS_COINS_OFFSET == jetsam_fri_binius::zk_affine_code::AFFINE_PCS_COINS_START
);
const _: () =
    assert!(ZK_AUTH_CAPSULE_PCS_COINS_LEN == jetsam_fri_binius::zk_affine_code::AFFINE_PCS_COINS_LEN);
const _: () = assert!(
    ZK_AUTH_CAPSULE_LIBRA_MASK_OFFSET == jetsam_fri_binius::zk_affine_code::AFFINE_LIBRA_MASK_START
);
const _: () = assert!(
    ZK_AUTH_CAPSULE_LIBRA_MASK_LEN == jetsam_fri_binius::zk_affine_code::AFFINE_LIBRA_MASK_LEN
);
const _: () = assert!(
    ZK_AUTH_CAPSULE_REMAINING_PADDING_OFFSET
        == jetsam_fri_binius::zk_affine_code::AFFINE_FRESH_PADDING_START
);
const _: () = assert!(
    ZK_AUTH_CAPSULE_REMAINING_PADDING_LEN
        == jetsam_fri_binius::zk_affine_code::AFFINE_FRESH_PADDING_LEN
);
const _: () = assert!(
