...
|---|---|
| Wallet query geometry and Johnson ledger | [`ZK_AUTH_CAPSULE_GEOMETRY`](../../jetsam_fri_binius/src/zk_capsule.rs) and [`conditional_selected_zk_auth_base_iop_ledger`](../../jetsam_gkr/src/zk_auth_qrom.rs) |
| C1 challenge support | [`C1_CHALLENGE_MIN_ENTROPY_BITS`](../../jetsam_ivc_core/src/field/gf2_256.rs) |
| History query count | [`HISTORY_STEP_FRI_QUERIES`](../../jetsam_recursive/src/acceptance/history_step_bank.rs) |
| Canonical B25 and B255 PCS profiles | [`canonical_history_step_pcs_params`](../../jetsam_recursive/src/acceptance/history_step_bank.rs) |
| BaseFold query count | [`BASEFOLD_RATE_QUARTER_C1_QUERIES`](../../jetsam_ivc_core/src/pcs/basefold.rs) |
| Sidecar transcript groups | [`JOINT_C1_GROUPS`](../../jetsam_recursive/src/region_sidecar.rs) |
| Poseidon2b profile | [`STATE_SIZE`, `SBOX_EXPONENT`, `F_ROUNDS`, `P_ROUNDS`](../../jetsam_poseidon2b/src/native/permutation.rs) and [`RATE`](../../jetsam_poseidon2b/src/native/compression.rs) |
| Poseidon2b linear layers and Merkle compression | [`MDS_FULL`, `MDS_PARTIAL`](../../jetsam_poseidon2b/src/native/permutation.rs) and [`compress_flat_feed_forward_with_tag`](../../jetsam_poseidon2b/src/native/compression.rs) |
| Digest width | the size of [`Digest`](../../jetsam_poseidon2b/src/primitives.rs) |
...
projection, [`ChainAccumulator::advance`](../../jetsam_recursive/src/accumulator.rs),
[`verify_history_step_terminal`](../../jetsam_recursive/src/acceptance/history_step/relation.rs),
the [native consensus predicates](../../jetsam_chain/src/consensus/validation.rs)
and
[`materialize_accepted_block_state`](../../jetsam_chain/src/block.rs) together
