...
use jetsam_recursive::acceptance::history_step_bank::HISTORY_STEP_FRI_QUERIES;
use jetsam_recursive::{canonical_history_step_class_id, canonical_history_step_pcs_params};
...
impl ProductionParameters {
    pub fn load() -> Result<Self, String> {
        ...
        let geometry = jetsam_fri_binius::ZK_AUTH_CAPSULE_GEOMETRY;
