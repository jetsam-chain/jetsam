...
use elide_poseidon2b::primitives::{Address, Commitment, Digest, TxBodyHash};
...
impl TxInput {
    ...
    pub fn commitment(&self, owner: &Address) -> Commitment {
        elide_poseidon2b::primitives::hash_utxo_leaf(
...
/// (960 / 144 = 6.67). Must stay equal to `elide_chain`'s copy.
