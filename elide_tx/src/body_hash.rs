...
use elide_poseidon2b::primitives::{hash_tx8x2_leaves, TxBodyHash, TX8X2_LEAF_COUNT};
...
mod tests {
    ...
    use elide_core::CanonicalSerialize;
    use elide_poseidon2b::native::{capacity_iv, compress, TAG_TX8X2};
    use elide_poseidon2b::primitives::Address;
    use elide_poseidon2b::Poseidon2bPermutation;
