...
//!
//! Key differences from the generic `elide_fri::prover`:
...
use elide_fri::code::{fold, Code, LOG_RATE};
...
///
/// Same protocol as `elide_fri::prover::prove` but with COMPACT_TAU and
