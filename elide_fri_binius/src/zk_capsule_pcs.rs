...
///
/// ```compile_fail
/// use elide_fri_binius::ZkCapsulePcsSourceProverState;
///
...
/// use elide_fri_binius::{zk_capsule_pcs_bind_phase_a, ZkCapsulePcsSourceProverState};
///
...
/// ```compile_fail
/// use elide_core::Block128;
/// use elide_fri_binius::{zk_capsule_pcs_commit_mid, ZkCapsulePcsSourceProverState};
///
