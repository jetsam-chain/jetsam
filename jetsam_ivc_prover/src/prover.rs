...
use jetsam_ivc_core::lincheck::{self, QuirkyPoint, pack_z_lincheck_from_packed};
use jetsam_ivc_core::pcs::{self, Commitment, PcsParams};
use jetsam_ivc_core::proof::{R1csClaim, R1csProof, R1csProofLigerito, ZClaim, bind_statement};
use jetsam_ivc_core::r1cs::BlockR1cs;
use jetsam_ivc_core::zerocheck;
...
/// [`jetsam_ivc_core::verifier::verify_claims`].
...
pub fn prove_fast_from_witness<Ch: Challenger>(
    ...
    jetsam_ivc_core::scratch::give_f128(core.z_packed);
...
pub fn prove_fast_core_with_codeword<Ch: Challenger>(
    ...
    jetsam_ivc_core::scratch::give_f128(a_packed_f128);
    jetsam_ivc_core::scratch::give_f128(b_packed_f128);
