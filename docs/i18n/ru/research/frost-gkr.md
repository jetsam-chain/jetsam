...
[Прочитать статью](https://jetsamchain.com/research/) ·
[Открыть публикацию Jetsam Lab](https://jetsamchain.com/research/) ·
...
FROST-GKR появился внутри системы доказательств Jetsam и используется для
...
частью архитектуры доказательств Jetsam. Это исследование **Jetsam Lab**.
