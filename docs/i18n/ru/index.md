...
Jetsam создан, чтобы убрать эту зависимость.
...
При отправке JTM кошелёк выбирает свои UTXO и создаёт одну атомарную
...
Jetsam не зависит от истории, но не является системой без состояния.
...
Jetsam прозрачен и не является приватным блокчейном. Значения, владельцы и
...
| Параметр | Значение |
|---|---:|
| Средний целевой интервал блока | 90 секунд |
