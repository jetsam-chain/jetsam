...
При отправке ELD кошелёк выбирает свои UTXO и создаёт одну атомарную
...
- Установите нативный GUI-кошелёк из
  [последнего релиза](https://github.com/ignotusnemo/elide/releases). Он
...
- Изучите или соберите
  [исходный код](https://github.com/ignotusnemo/elide) с закреплённой версией
  Rust toolchain.
