...
[Block–Tiwari 推导](https://github.com/ignotusnemo/elide/blob/main/jetsam_soundness/docs/block-tiwari.md)证明每个实际部署
...
[端到端 QROM 推导](https://github.com/ignotusnemo/elide/blob/main/jetsam_soundness/docs/category-one.md)给出可靠性游戏、
归约、有限规模修正项和全部前提。[`jetsam_soundness` 证书](https://github.com/ignotusnemo/elide/tree/main/jetsam_soundness)
