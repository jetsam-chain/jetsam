...
完整计算以及与已发布系统的比较见
[Block–Tiwari 推导](https://github.com/ignotusnemo/elide/blob/main/elide_soundness/docs/block-tiwari.md)。
...
[QROM 与 Category 1 推导](https://github.com/ignotusnemo/elide/blob/main/elide_soundness/docs/category-one.md)，命题边界见
