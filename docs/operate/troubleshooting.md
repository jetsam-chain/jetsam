...
If accepting inbound connections, allow TCP `9700` in both host and upstream
firewalls.

Do not open RPC `9701` as a substitute for P2P.
...
Find which process owns `9700` or `9701`. Only one node may bind a listener and
