...
The [Block–Tiwari derivation](https://github.com/jetsam-chain/jetsam/blob/master/jetsam_soundness/docs/block-tiwari.md) proves
...
The [end-to-end QROM derivation](https://github.com/jetsam-chain/jetsam/blob/master/jetsam_soundness/docs/category-one.md)
states the game, reductions, finite terms and assumptions. The
[`jetsam_soundness` certificate](https://github.com/jetsam-chain/jetsam/tree/master/jetsam_soundness) imports the
