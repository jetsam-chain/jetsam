...
The [Block–Tiwari derivation](https://github.com/ignotusnemo/elide/blob/main/elide_soundness/docs/block-tiwari.md) proves
...
The [end-to-end QROM derivation](https://github.com/ignotusnemo/elide/blob/main/elide_soundness/docs/category-one.md)
states the game, reductions, finite terms and assumptions. The
[`elide_soundness` certificate](https://github.com/ignotusnemo/elide/tree/main/elide_soundness) imports the
