...
use elide_fri_binius::zk_affine_code::{
...
mod tests {
    use super::*;
    use elide_fri_binius::zk_affine_code::ZkAffineLchCode;
    use elide_fri_binius::zk_capsule_algebra::certify_source_query_hiding_rank;
