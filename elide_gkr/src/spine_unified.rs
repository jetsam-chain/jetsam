...
use elide_core::hardware::{clmul_gcm, flat_to_tower_u128, square_flat_u128, tower_to_flat_u128};
use elide_core::mle::eq::eq_ind;
use elide_core::mle::evaluate::{evaluate_flat, evaluate_preflat, evaluate_slice};
use elide_core::mle::fold::fold_highest_var_inplace;
use elide_core::packed::pow7::{pow7_block128, pow7_flat_block128};
