...
use elide_fri_binius::zk_affine_code::{ZkAffineCodeError, ZkAffineLchCode};
...
use elide_fri_binius::zk_phase_a::{phase_a_virtual_oracle, ZkPhaseAError};
use elide_poseidon2b::native::permutation::{MDS_FULL, STATE_SIZE};
...
///
/// ```compile_fail
/// use elide_gkr::zk_auth_rbr::ZkAuthKnowledgeWitness;
