...
use elide_fri_binius::zk_phase_a::ZkPhaseAProof;
...
mod tests {
    ...
    use elide_fri_binius::interleaved_commit::{MerkleCap, SourceBatchedMerkleProof, SourceHash};
    use elide_fri_binius::zk_capsule_algebra::{TAIL_SYMBOLS, UPPER_SYMBOLS};
    use elide_fri_binius::zk_capsule_pcs::{
        ZkCapsulePcsMidCommitment, ZkCapsulePcsOpening, ZkCapsulePcsSourceCommitment,
        ZkCapsulePcsTailReveal,
    };
