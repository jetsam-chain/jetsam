...
use elide_fri_binius::zk_affine_code::AFFINE_CODE_LOG_RATE;
use elide_fri_binius::zk_capsule::ZK_AUTH_CAPSULE_GEOMETRY;
...
use elide_poseidon2b::channel::Poseidon2bWideChannel;
...
pub(crate) fn absorb_phase_a_round(
    channel: &mut Poseidon2bWideChannel,
    round: &elide_fri_binius::ZkPhaseARoundProof<Block256>,
) {
