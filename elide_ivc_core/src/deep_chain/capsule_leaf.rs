...
use elide_poseidon2b::native::domain::{TAG_CAPS256, TAG_CAPSLEAF, TAG_CAPSMIX, capacity_iv_flat};
use elide_poseidon2b::native::permutation::STATE_SIZE;

/// Symbols per capsule leaf — mirrors
/// `elide_fri_binius::capsule::CAPSULE_LEAF_SYMBOLS`. Kept in sync with the
...
mod tests {
    use super::*;
    use elide_poseidon2b::Poseidon2bFlatSponge;
