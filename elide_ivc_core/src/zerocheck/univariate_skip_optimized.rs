...
mod tests {
    ...
    ///
    /// Covers non-byte-aligned, larger non-byte-aligned, and exact-boundary
    /// padding shapes. The exact-boundary case also exercises full-skip chunks.
    #[test]
