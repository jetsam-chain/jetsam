...
//! coordinate-wise basis bridge to [`elide_core::Block256`] a field
...
fn tower_f128(value: F128) -> Block128 {
    ...
    Block128(elide_core::hardware::flat_to_tower_u128(flat))
}
...
impl Mul for F256 {
    ...
    fn mul(self, rhs: Self) -> Self {
        ...
        if elide_core::cpu::avx2_vpclmul_available() {
...
unsafe fn mul_f256_avx2(left: F256, right: F256) -> F256 {
    use elide_core::packed::{PackedBlock128, clmul_avx2::packed_mul_flat_avx2};
