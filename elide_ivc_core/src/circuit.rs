...
//!
//! The field laws come from `elide_core`; this module only materializes those
//! laws as Boolean R1CS constraints.

use elide_core::{Block8, Block16, Block32, Block64, Block128, TowerField};
...
mod tests {
    ...
    #[test]
    fn block128_mul_gadget_matches_elide_core() {
