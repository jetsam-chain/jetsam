...
pub(crate) fn row_ledger_mark(
    builder: &jetsam_ivc_core::field_circuit::FieldR1csBuilder,
    last: &mut usize,
    label: &str,
) {
...
pub(crate) fn expand_empty_field_tail(
    mut r1cs: jetsam_ivc_core::field_r1cs::FieldR1cs,
    mut witness: Vec<jetsam_ivc_core::field::F128>,
    ...
    let expand = |matrix: &mut jetsam_ivc_core::field_r1cs::SparseFieldMatrix| {
