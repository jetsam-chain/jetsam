...
use jetsam_ivc_core::deep_chain::capsule_leaf::raw_flat_lane;
...
use jetsam_ivc_core::pcs::{C1QuirkyDirectClaim, PcsParams};
use jetsam_ivc_core::public_io::{PublicIoSpec, WitnessSlice};
use jetsam_poseidon2b::native::domain::{
...
fn selected_duplex_vk_matches(
    vk: &DuplexRegionVk,
    layout: &jetsam_ivc_core::deep_chain::schedule::DuplexLayout,
    purpose: [u8; 32],
    w_log: usize,
    tile_log: usize,
) -> bool {
...
pub(crate) fn shape_only_c1_block_region_walk_deferred_proof(
    ...
    use jetsam_ivc_core::deep_chain::relations::c1::{C1ColumnRelationProof, C1ShiftDischargeProof};
    ...
    let relation = |rounds: usize, values: usize| C1ColumnRelationProof {
        rounds: vec![[F256::ZERO; jetsam_ivc_core::deep_chain::relations::RELATION_DEGREE]; rounds],
