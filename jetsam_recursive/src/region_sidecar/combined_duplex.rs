...
use jetsam_ivc_core::verifier::FieldPostCommitVerifierContext;
use jetsam_ivc_prover::field_prover::FieldPostCommitProverContext;
...
const COMBINED_DUPLEX_LAYOUT_DIGEST_DOMAIN: &[u8] =
    b"JTM/REGION-SIDECAR/COMBINED-DUPLEX-LAYOUT/V1";
const COMBINED_DUPLEX_VK_DIGEST_DOMAIN: &[u8] = b"JTM/REGION-SIDECAR/COMBINED-DUPLEX-VK/V1";
...
pub(in crate::region_sidecar) mod tests {
    ...
    use jetsam_ivc_core::deep_chain::schedule::{carry_selection_terms, TranscriptOp};
    ...
    fn combined_descriptor_preflight_is_checked_and_bounded() {
        assert_eq!(
            (2 * jetsam_ivc_core::pcs::basefold::default_fri_queries(17, 1))
                .next_power_of_two()
