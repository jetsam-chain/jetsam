...
use jetsam_ivc_core::deep_chain::ff_merkle::{ff_merkle_fixed_patterns, FfMerklePathFamily};
...
const DUPLEX_LAYOUT_DIGEST_DOMAIN: &[u8] = b"JTM/REGION-SIDECAR/DUPLEX-LAYOUT/V1";
const DUPLEX_VK_DIGEST_DOMAIN: &[u8] = b"JTM/REGION-SIDECAR/DUPLEX-VK/V1";
const DUPLEX_SIDECAR_TRANSCRIPT_LABEL: &[u8] = b"history-region-sidecar-duplex-v1";
const MERKLE_LAYOUT_DIGEST_DOMAIN: &[u8] = b"JTM/REGION-SIDECAR/MERKLE-LAYOUT/V1";
const MERKLE_VK_DIGEST_DOMAIN: &[u8] = b"JTM/REGION-SIDECAR/MERKLE-VK/V1";
...
mod tests {
    ...
    fn strided_feed_forward_ten_plus_six_matches_dense_wallet_layout_end_to_end() {
        ...
        let mut place = |columns: &jetsam_ivc_core::deep_chain::ff_merkle::FfMerklePathColumns,
                         depth: usize,
                         source_stride: usize,
