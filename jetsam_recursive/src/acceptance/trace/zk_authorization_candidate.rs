...
use jetsam_fri_binius::interleaved_commit::SourceHash;
use jetsam_fri_binius::zk_capsule_algebra::{
    JOINT_SOURCE_LEAF_SYMBOLS, MID_STANDARD_FOLDS, SOURCE_QUERY_BITS,
};
use jetsam_gkr::zk_authorization::{
    verify_zk_authorization, ZkAuthorizationError, ZkAuthorizationProof, ZkAuthorizationVerified,
};
use jetsam_gkr::ZkAuthorizationWireEncodeError;
use jetsam_ivc_core::deep_chain::capsule_leaf::{
...
fn canonical_selected_zk_ghost_statement() -> jetsam_gkr::zk_authorization::ZkAuthCapsuleOwnerStatement
{
    let body = jetsam_gkr::ghost_tx::ghost_tx_body();
...
pub(super) struct SelectedZkAuthorizationVerifiedEntry {
    statement: jetsam_gkr::zk_authorization::ZkAuthCapsuleOwnerStatement,
    proof: ZkAuthorizationProof,
...
pub(in crate::acceptance) fn prepare_selected_zk_authorizations(
    statements: &[jetsam_gkr::zk_authorization::ZkAuthCapsuleOwnerStatement],
...
impl SelectedZkAuthorizationVerifiedEntry {
    pub(super) fn statement(&self) -> jetsam_gkr::zk_authorization::ZkAuthCapsuleOwnerStatement {
        self.statement
    }
...
mod tests {
    ...
    use jetsam_core::mle::evaluate::evaluate_slice;
    use jetsam_core::mle::fold::fold_variable_inplace;
    use jetsam_core::{Block128, Block256, TowerField};
    use jetsam_fri_binius::capsule::capsule_query_bit_location;
    use jetsam_fri_binius::zk_affine_code::{ZkAffineLchCode, AFFINE_CODE_MESSAGE_LEN};
    use jetsam_fri_binius::zk_capsule_algebra::{
    ...
    use jetsam_fri_binius::zk_phase_a::{
        prove_phase_a, verify_phase_a, ZkPhaseARoundProof, PHASE_A_ORACLE_LEN,
    };
    use jetsam_gkr::layers::evaluate_permutation;
    use jetsam_gkr::zk_auth_capsule::{
    ...
    use jetsam_gkr::zk_mlecheck::ZkMleCheckRoundProof;
    use jetsam_ivc_core::deep_chain::capsule_leaf::{flat_c1_capsule_leaf_hash, C1CapsuleLeafKind};
    use jetsam_ivc_core::deep_chain::schedule::LaneSource;
    use jetsam_ivc_core::field_r1cs::FieldR1cs;
    use jetsam_poseidon2b::native::domain::{capacity_iv, TAG_ADDRFIX};
