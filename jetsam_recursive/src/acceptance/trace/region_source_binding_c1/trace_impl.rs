...
use jetsam_ivc_core::deep_chain::relations::c1::claimed_refs;
use jetsam_ivc_core::deep_chain::relations::ColRef;
...
fn preflight_c1_relation(
    proof: &jetsam_ivc_core::deep_chain::relations::c1::C1ColumnRelationProof,
    w_log: usize,
    values: usize,
) -> bool {
...
fn preflight_c1_shifts(
    proofs: &[jetsam_ivc_core::deep_chain::relations::c1::C1ShiftDischargeProof],
    count: usize,
    w_log: usize,
) -> bool {
...
fn verify_c1_merkle_claim_pass_trace<C: FsChannelOps>(
    ...
    values: &[ExtExpr],
    point: &[ExtExpr],
    native_shifts: &[jetsam_ivc_core::deep_chain::relations::c1::C1ShiftDischargeProof],
