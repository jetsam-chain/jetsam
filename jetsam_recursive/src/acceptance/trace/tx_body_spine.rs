...
//!   `jetsam_gkr::block_spine::verify_block_spine_killshot` (the final
...
use jetsam_gkr::block_spine::{num_vars_for, BlockSpineProof, BLOCK_SPINE_TX_HASH_PIN_TAG};
use jetsam_gkr::spine_sumcheck::N_SPINE_SLOTS;
use jetsam_gkr::tx_body_layout::InstanceRole;
...
pub use jetsam_tx::body_hash::BODY_HASH_LEAVES as TX_BODY_RAW_LEAVES;
