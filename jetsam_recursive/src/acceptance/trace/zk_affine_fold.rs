...
use jetsam_fri_binius::zk_affine_code::{ZkAffineCodeError, ZkAffineLchCode, AFFINE_CODE_LOG_LEN};
...
mod tests {
    ...
    use jetsam_fri_binius::zk_capsule_algebra::{fold_joint_source_leaf, mid_standard_fold4};
