...
//!
//! This module mirrors [`jetsam_gkr::zk_mlecheck::ZkMleCheckVerifierState`]
...
mod tests {
    ...
    ) -> jetsam_gkr::zk_mlecheck::ZkMleCheckVerifierOutput<Block256> {
    ...
    fn build_trace(
        ...
        Vec<jetsam_ivc_core::field::F128>,
        usize,
