...
//!
//! Line-by-line transliterations of `jetsam_ivc_core::deep_chain`:
...
use jetsam_ivc_core::deep_chain::c1::C1MultiDeepChainWalkProof;
use jetsam_ivc_core::deep_chain::relations::c1::{
...
use jetsam_ivc_core::deep_chain::schedule::flat_of_tower_u128;
use jetsam_ivc_core::deep_chain::{
    flat_mds, flat_round_constant, is_full_round, DeepChainWalkProof, MultiDeepChainWalkProof,
    WALK_DEGREE,
};
use jetsam_ivc_core::field_circuit::FsChannelOps;
#[cfg(test)]
use jetsam_ivc_core::field_circuit::FsChannelTrace;
use jetsam_poseidon2b::native::permutation::{N_ROUNDS, STATE_SIZE};
...
mod tests {
    ...
    fn c1_ragged_walk_twin_lockstep_rows_and_mutations() {
        use jetsam_ivc_core::deep_chain::c1::{prove_ragged_deep_chain_walk, C1LaneClaimGroup};
        ...
        let mut channel = jetsam_ivc_core::field_circuit::FsChannelUnionRecorder::new_c1(
    ...
    fn c1_relation_and_shift_twins_lockstep_rows_and_mutations() {
        ...
        use jetsam_ivc_core::deep_chain::relations::RelationColumns;
        ...
        let mut builder = FieldR1csBuilder::new();
        let mut channel =
            jetsam_ivc_core::field_circuit::FsChannelUnionRecorder::new_c1(b"c1-relation-shift-twin");
    ...
    fn fixed_pattern_twin_lockstep_and_mutations() {
        use jetsam_ivc_core::deep_chain::relations::FixedPattern;
        let w_log = 4;
        let low_log = 2;
        let w = 1usize << w_log;
        ...
        let terms = vec![
            jetsam_ivc_core::deep_chain::relations::RelationTerm {
                coeff: F128::ONE,
    ...
    fn weighted_sum_source_binding_twin() {
        use jetsam_ivc_core::deep_chain::encode_kernel::source_weight_at;
        use jetsam_ivc_core::deep_chain::relations::prove_weighted_sum;
