...
use jetsam_ivc_core::proof::pcs_params_statement_bytes;
...
use jetsam_ivc_core::field_circuit::RecordedChannel as FsRecordedChannel;
...
impl HistoryStepParentGeometry {
    ...
    pub(crate) fn new(
        ...
        let tier_count = jetsam_chain::consensus::params::BLOCK_PAGE_CLASS_TIERS.len();
...
fn native_leaf_digest(lanes: &[F128]) -> [F128; 2] {
    ...
    flat_digest_lanes(&jetsam_ivc_core::merkle::hash_leaf(&bytes))
}
...
mod tests {
    ...
    use jetsam_ivc_core::field_circuit::{ExtExpr, FsChannelOps};
