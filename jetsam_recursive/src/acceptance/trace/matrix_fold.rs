//! Trace twin of `jetsam_ivc_core::matrix_claim::verify_matrix_claim_fold`
...
use jetsam_ivc_core::matrix_claim::c1::{C1MatrixAccClaim, C1MatrixFoldProof};
use jetsam_ivc_core::matrix_claim::MatrixFoldProof;
...
impl MatrixAccClaimTrace {
    pub fn alloc(
        ...
        native: &jetsam_ivc_core::matrix_claim::MatrixAccClaim,
    ) -> Self {
        Self {
            point: native
                .point
