...
pub const INPUT_SELECTORS: usize = jetsam_tx::TX_INPUTS;
pub const OUTPUT_SELECTORS: usize = jetsam_tx::TX_OUTPUTS;
...
pub fn bind_development_payout_action(
    ...
    gate_expected(
        ...
        Block128::from((jetsam_tx::output_bitmap_bit(0) | jetsam_tx::output_bitmap_bit(1)) as u128),
    );
...
mod tests {
    ...
    use jetsam_core::{Block128, TowerField};
    use jetsam_gkr::{spine_statement::spine_inputs_from_body, SpineInputs};
    ...
    fn development_payout_is_exact_when_live_and_canonical_ghost_when_dead() {
        ...
        let ghost = spine_inputs_from_body(&jetsam_gkr::ghost_tx::ghost_tx_body());
