...
use jetsam_ivc_core::matrix_claim::c1::{C1FreshLincheckClaim, C1MatrixFoldProof};
use jetsam_ivc_core::pcs::{Commitment, PcsParams};
...
use jetsam_ivc_prover::field_prover::{
...
pub use relation::{
    ...
    is_base_terminal_height, pin_history_step_class_bank, prepare_history_step_for_pow,
...
pub struct AuthorizationComponentInput {
    ...
    pub tx_index: usize,
    pub tx_body_hash: [jetsam_core::Block128; 2],
    pub public: jetsam_gkr::OwnerAuthPublicInputs,
}
...
pub struct ExactStateStructuralFrontierInputs {
    ...
    pub old_slot_leaves: Vec<jetsam_gkr::SlotLeafInputs>,
    pub new_slot_leaves: Vec<jetsam_gkr::SlotLeafInputs>,
    pub live_sibling_digests: Vec<jetsam_chain::exact_state_hash::StateHash>,
    pub old_combine_digests: Vec<jetsam_chain::exact_state_hash::StateHash>,
    pub new_combine_digests: Vec<jetsam_chain::exact_state_hash::StateHash>,
    pub old_root: jetsam_chain::exact_state_hash::StateHash,
    pub new_root: jetsam_chain::exact_state_hash::StateHash,
}
...
pub struct HistoryStepBlockComponents {
    ...
    pub tx_body_inputs: Vec<jetsam_gkr::SpineInputs>,
    pub tx_body_hashes: Vec<[jetsam_core::Block128; 2]>,
    pub tx_root_inputs: Vec<jetsam_gkr::MerklePathInputs>,
...
pub fn prepare_history_step_ghost_authorization(
    proof: jetsam_gkr::zk_authorization::ZkAuthorizationProof,
...
pub fn prepare_history_step_authorizations_in<const TIER: usize>(
    ...
    if inputs.iter().any(|input| {
        input.public.layout != jetsam_gkr::OwnerAuthLayout::FIXED
    ...
    let statements = inputs
        .iter()
        .map(
            |input| jetsam_gkr::zk_authorization::ZkAuthCapsuleOwnerStatement {
...
impl<const TIER: usize> HistoryStepBlockInput<TIER> {
    ...
    pub fn try_new_in(
        ...
        let semantic_id = jetsam_chain::block_header::semantic_header_id(sealed_header);
