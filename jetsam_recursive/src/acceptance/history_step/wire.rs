...
//! authenticated class/runtime. Before v1.2 activation the legacy full-path
...
use jetsam_ivc_core::pcs::basefold::{C1QueryOpening, C1RoundMessage};
...
fn decode_field_proof(
    ...
    let skip = 1usize << shape.k_skip;
    let zerocheck = jetsam_ivc_core::zerocheck::field_c1::C1ZerocheckProof {
    ...
    let lincheck = jetsam_ivc_core::lincheck::c1::C1LincheckProof {
...
pub fn decode_history_step_terminal(
    ...
    decode_terminal_with_activation(
        runtime,
        bytes,
        jetsam_chain::consensus::params::V1_2_ACTIVATION_HEIGHT,
    )
}
