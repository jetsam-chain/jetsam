...
use jetsam_ivc_core::challenger::{
...
pub(super) struct BaseSelectableParentRecorder {
    ...
    ops: Vec<jetsam_ivc_core::deep_chain::schedule::TranscriptOp>,
...
impl BaseSelectableParentRecorder {
    ...
    fn close_absorb(&mut self) {
        if !self.cur_absorb.is_empty() {
            self.ops
                .push(jetsam_ivc_core::deep_chain::schedule::TranscriptOp::Absorb(
...
impl FsChannelOps for BaseSelectableParentRecorder {
    ...
    fn sample_f128(&mut self, builder: &mut FieldR1csBuilder) -> LinExpr {
        ...
        self.close_absorb();
        self.ops
            .push(jetsam_ivc_core::deep_chain::schedule::TranscriptOp::Squeeze(
                1,
            ));
...
mod tests {
    ...
    use jetsam_ivc_core::field_circuit::FsChannelUnionRecorder;
