...
use jetsam_ivc_core::deep_chain::flat_mds;
...
use jetsam_ivc_core::deep_chain::source_tree::compress_iv_flat;
...
use jetsam_recursive::acceptance::trace::{mul, pin_eq};
...
fn source_leaf_substitution_terms_native(
    refs: &jetsam_ivc_core::deep_chain::leaf_hash::SourceLeafRefs,
    alpha: F128,
) -> Vec<RelationTerm> {
    jetsam_ivc_core::deep_chain::leaf_hash::source_leaf_substitution_terms(refs, alpha)
}
