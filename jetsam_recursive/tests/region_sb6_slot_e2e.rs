...
use jetsam_poseidon2b::native::domain::{capacity_iv, TAG_COMPRESS};
...
fn run_merkle_native(
    ...
    use jetsam_ivc_core::deep_chain::schedule::merkle_booleanity_terms;
...
fn region_sb6_slot_end_to_end() {
    ...
    let flip = |slice_idx: usize, off: usize| {
        ...
        let mut chp = FsLaneChallenger::new(b"region-sb6-slot");
        let (bp, bc, _) = jetsam_ivc_prover::field_prover::prove_field_with_public_io(
