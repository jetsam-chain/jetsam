...
use jetsam_fri::code::{Code, LOG_RATE};
use jetsam_ivc_core::challenger::{Challenger, FsLaneChallenger};
use jetsam_ivc_core::deep_chain::encode_kernel::{encode_mle_via_kernel, eq_at, source_weight_at};
use jetsam_ivc_core::deep_chain::relations::{prove_weighted_sum, verify_weighted_sum};
...
fn sb1_2_code_tree_binds_encode_reduction() {
    use jetsam_fri::merkle::MerkleTree;
    use jetsam_ivc_core::deep_chain::source_tree::{build_source_tree_columns, SourceTree};
    use jetsam_poseidon2b::hasher::CryptographicHasher;
