...
const BODY_DIGEST_DOMAIN: &[u8] = b"JTM/P2P/OBJECT/BLOCK-BODY/V2";
const TERMINAL_DIGEST_DOMAIN: &[u8] = b"JTM/P2P/OBJECT/HISTORY-TERMINAL/V2";
const MANIFEST_DIGEST_DOMAIN: &[u8] = b"JTM/P2P/OBJECT/SNAPSHOT-MANIFEST/V2";
const SEGMENT_DIGEST_DOMAIN: &[u8] = b"JTM/P2P/OBJECT/STATE-SEGMENT/V2";
