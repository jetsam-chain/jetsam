...
BASE = Path(
    os.environ.get(
        "JETSAM_LIVE_EXACT_FANOUT_DIR",
        str(RUN_PARENT / f"exact-object-fanout-clean-{STAMP}"),
    )
)
BASE_PORT = int(os.environ.get("JETSAM_LIVE_EXACT_FANOUT_BASE_PORT", "24600"))
PEER_COUNT = int(os.environ.get("JETSAM_LIVE_EXACT_FANOUT_PEERS", "24"))
TARGET_HEIGHT = int(os.environ.get("JETSAM_LIVE_EXACT_FANOUT_HEIGHT", "3"))
