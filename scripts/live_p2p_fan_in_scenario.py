...
BASE = Path(
    os.environ.get(
        "JETSAM_LIVE_P2P_FAN_IN_DIR",
        str(RUN_PARENT / f"p2p-fan-in-clean-{STAMP}"),
    )
)
BASE_PORT = int(os.environ.get("JETSAM_LIVE_P2P_FAN_IN_BASE_PORT", "21000"))
PEER_COUNT = int(os.environ.get("JETSAM_LIVE_P2P_FAN_IN_PEERS", "96"))
