...
PAYMENT_MICRO_JTM = int(os.environ.get("JETSAM_LIVE_STATE_SLOT_PAYMENT", "1000000"))
SEGMENT_LOG = 16
...
def main():
    ...
    try:
        ...
        plan = rpc(
            node.rpc_port,
            "walletPlanSend",
            [recipient["address"], PAYMENT_MICRO_JTM, 0],
        )
        ...
        require(
            int(recipient_slots[0]["value"]) == PAYMENT_MICRO_JTM,
