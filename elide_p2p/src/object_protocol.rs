...
pub const MAX_OBJECT_RESPONSE_PAYLOAD_BYTES: usize =
    elide_chain::consensus::wire_limits::MAX_HISTORY_STEP_TERMINAL_BYTES;
...
const BODY_DIGEST_DOMAIN: &[u8] = b"ELD/P2P/OBJECT/BLOCK-BODY/V2";
const TERMINAL_DIGEST_DOMAIN: &[u8] = b"ELD/P2P/OBJECT/HISTORY-TERMINAL/V2";
const MANIFEST_DIGEST_DOMAIN: &[u8] = b"ELD/P2P/OBJECT/SNAPSHOT-MANIFEST/V2";
const SEGMENT_DIGEST_DOMAIN: &[u8] = b"ELD/P2P/OBJECT/STATE-SEGMENT/V2";
