...
use elide_core::packed::{PackedBlock128, PACKED_LANES};
...
fn scalar_hash_pair(a: Block128, b: Block128) -> [u8; 32] {
    ...
    use elide_core::{CanonicalSerialize, TowerField};
...
pub(crate) fn avx2_vpclmul_runtime() -> bool {
    ...
    elide_core::cpu::avx2_vpclmul_available()
}
...
pub(crate) fn avx512_vpclmul_runtime() -> bool {
    ...
    elide_core::cpu::avx512_vpclmul_available()
}
...
pub(crate) fn pmull_runtime() -> bool {
    ...
    elide_core::cpu::pmull_available()
}
