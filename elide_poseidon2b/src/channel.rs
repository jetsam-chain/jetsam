...
//! [`elide_core::transcript::FiatShamir`].
//!
//! This is the *production* transcript for protocols in `elide_core` that
...
//! test vectors downstream (notably in `elide_fri` prover/verifier and
