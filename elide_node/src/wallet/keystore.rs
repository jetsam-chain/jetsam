...
//!
//! Format: `elide_plain_key_1` (16 bytes magic) + secret (32 bytes) = 48 bytes.
//!
...
impl MasterSecret {
    ...
    pub(super) fn derive_spend_secret(&self, index: u32) -> SpendSecret {
        ...
        sponge.absorb(Block128::from(0x6E6F69642D64657269_u128)); // "elide-deri"
    ...
    pub(super) fn derive_address(&self, index: u32) -> Address {
        ...
        elide_poseidon2b::primitives::derive_address(&secret)
    }
}
