...
use elide_recursive::acceptance::history_step_bank::CanonicalHistoryStepClassId;
...
fn render_generated_pack(
    ...
    for (index, leaf) in leaves.iter().enumerate() {
        ...
        writeln!(
            &mut generated,
            "        unsafe {{ elide_miner::EmbeddedHistoryStepMatrixLeaf::from_release_build(\n            elide_recursive::acceptance::history_step_bank::CanonicalHistoryStepClassId::from_index({index}).unwrap(),\n            include_bytes!(concat!(env!(\"OUT_DIR\"), \"/{STAGED_DIRECTORY}/{}\")),\n            elide_ivc_core::field_r1cs::BuildAuthenticatedFieldR1csSeal::from_release_build(\n                elide_ivc_core::proof::FieldShape {{ m: {}, k_log: {}, k_skip: {}, const_pin: {} }},\n                {},\n                {},\n            ),\n        ) }},",
