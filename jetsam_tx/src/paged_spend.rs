...
use jetsam_poseidon2b::native::{capacity_iv, DomainTag, Poseidon2bSponge};
use jetsam_poseidon2b::primitives::{Address, Digest, TxBodyHash};
...
mod tests {
    ...
    fn one_page_vector_and_intent_roundtrip_are_frozen() {
        ...
        assert_eq!(
            ...
            [
                179, 68, 208, 164, 246, 201, 109, 86, 20, 3, 107, 199, 225, 10, 128, 65, 161,
                163, 163, 169, 22, 128, 218, 141, 178, 185, 137, 227, 111, 133, 178, 65,
            ]
        );
    ...
    fn hundred_and_1020_inputs_are_one_logical_transaction() {
        ...
        assert_eq!(
            facts.logical_txid.0,
            [
                86, 166, 132, 182, 186, 197, 254, 16, 208, 119, 143, 166, 135, 117, 98, 199,
                137, 61, 230, 211, 222, 39, 2, 217, 210, 60, 150, 10, 145, 212, 177, 116,
            ]
        );
