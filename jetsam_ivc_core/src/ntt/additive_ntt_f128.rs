...
// strategy are original to HistoryProof.
...
fn butterfly_interleaved_block_par_rows(
    ...
    if num_ntts.is_multiple_of(4) && jetsam_core::cpu::avx512_vpclmul_available() {
...
unsafe fn butterfly_row_avx512(top: &mut [F128], bot: &mut [F128], twiddle: F128) {
    ...
    use jetsam_core::packed::clmul_avx512::{broadcast_u128, mul_gcm_x4};
