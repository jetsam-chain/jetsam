...
impl Mul for F128 {
    ...
    fn mul(self, rhs: Self) -> Self {
        ...
        {
            if jetsam_core::cpu::pmull_available() {
        ...
        {
            if jetsam_core::cpu::pclmul_available() {
...
pub mod x86_64_clmul {
    ...
    use jetsam_core::packed::clmul_avx512::mul_gcm_x4;
...
mod tests {
    ...
    fn x86_avx512_vec4_matches_software() {
        if !jetsam_core::cpu::avx512_vpclmul_available() {
            return;
        }
