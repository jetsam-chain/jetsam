...
//!
//! The field laws come from `jetsam_core`; this module only materializes those
//! laws as Boolean R1CS constraints.

use jetsam_core::{Block8, Block16, Block32, Block64, Block128, TowerField};
...
mod tests {
    ...
    #[test]
    fn block128_mul_gadget_matches_jetsam_core() {
