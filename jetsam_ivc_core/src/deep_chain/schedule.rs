...
pub fn flat_of_tower_u128(v: u128) -> F128 {
    let f = jetsam_core::hardware::tower_to_flat_u128(v);
    F128 {
        lo: f as u64,
        hi: (f >> 64) as u64,
    }
...
mod tests {
    ...
    /// REAL sponge-mode compress chain (`jetsam_poseidon2b::native::
    ...
    fn merkle_family_matches_native_compress_chain() {
        ...
        use jetsam_poseidon2b::native::domain::{TAG_COMPRESS, capacity_iv};
