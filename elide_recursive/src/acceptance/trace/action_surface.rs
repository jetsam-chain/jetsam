...
pub const INPUT_SELECTORS: usize = elide_tx::TX_INPUTS;
pub const OUTPUT_SELECTORS: usize = elide_tx::TX_OUTPUTS;
...
pub fn bind_development_payout_action(
    ...
    gate_expected(
        ...
        Block128::from((elide_tx::output_bitmap_bit(0) | elide_tx::output_bitmap_bit(1)) as u128),
    );
    gate_expected(b, &spine.leaves[LEAF_FLAGS][1], Block128::from(1u128));

    let recipients = [
        elide_chain::consensus::development_allocation::NETWORK_FUND_ADDRESS,
        elide_chain::consensus::development_allocation::LAB_FUND_ADDRESS,
    ];
...
mod tests {
    ...
    use elide_core::{Block128, TowerField};
    use elide_gkr::{spine_statement::spine_inputs_from_body, SpineInputs};
    ...
    fn development_payout_is_exact_when_live_and_canonical_ghost_when_dead() {
        ...
        let ghost = spine_inputs_from_body(&elide_gkr::ghost_tx::ghost_tx_body());
