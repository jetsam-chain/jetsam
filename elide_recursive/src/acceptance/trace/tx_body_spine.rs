...
//!   `elide_gkr::block_spine::verify_block_spine_killshot` (the final
...
use elide_gkr::block_spine::{num_vars_for, BlockSpineProof, BLOCK_SPINE_TX_HASH_PIN_TAG};
use elide_gkr::spine_sumcheck::N_SPINE_SLOTS;
use elide_gkr::tx_body_layout::InstanceRole;
use elide_gkr::{SpineCircuit, SpineInputs};
...
pub use elide_tx::body_hash::BODY_HASH_LEAVES as TX_BODY_RAW_LEAVES;
...
mod tests {
    ...
    use elide_gkr::spine_sumcheck::reconstruct_slot_states;
