...
use elide_poseidon2b::native::domain::{capacity_iv, capacity_iv_flat, TAG_CAPSNODE, TAG_KSCH256};
...
fn place_ff_dense(
    ...
    columns: &elide_ivc_core::deep_chain::ff_merkle::FfMerklePathColumns,
    n_paths: usize,
    depth: usize,
