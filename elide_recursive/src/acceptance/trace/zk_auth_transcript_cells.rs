...
use elide_ivc_core::deep_chain::schedule::{DuplexLayout, LaneSource};
...
#[cfg(test)]
mod tests {
    use elide_ivc_core::deep_chain::schedule::{build_duplex_columns, flat_of_tower_u128};
    use elide_ivc_core::field::{F128, F256};
    use elide_ivc_core::field_circuit::FieldR1csBuilder;
    use elide_poseidon2b::native::domain::{capacity_iv, TAG_KSCH256};
    ...
    fn built_matrix(salt: u128) -> elide_ivc_core::field_r1cs::FieldR1cs {
