...
use elide_fri_binius::interleaved_commit::SourceHash;
use elide_fri_binius::zk_capsule_algebra::{
    JOINT_SOURCE_LEAF_SYMBOLS, MID_STANDARD_FOLDS, SOURCE_QUERY_BITS,
};
use elide_gkr::zk_authorization::{
    verify_zk_authorization, ZkAuthorizationError, ZkAuthorizationProof, ZkAuthorizationVerified,
};
use elide_gkr::ZkAuthorizationWireEncodeError;
use elide_ivc_core::deep_chain::capsule_leaf::{
...
use elide_ivc_core::deep_chain::schedule::DuplexLayout;
...
fn canonical_selected_zk_ghost_statement() -> elide_gkr::zk_authorization::ZkAuthCapsuleOwnerStatement
{
    let body = elide_gkr::ghost_tx::ghost_tx_body();
...
pub(super) struct SelectedZkAuthorizationVerifiedEntry {
    statement: elide_gkr::zk_authorization::ZkAuthCapsuleOwnerStatement,
    proof: ZkAuthorizationProof,
...
pub(in crate::acceptance) fn prepare_selected_zk_authorizations(
    statements: &[elide_gkr::zk_authorization::ZkAuthCapsuleOwnerStatement],
...
impl SelectedZkAuthorizationVerifiedEntry {
    pub(super) fn statement(&self) -> elide_gkr::zk_authorization::ZkAuthCapsuleOwnerStatement {
        self.statement
    }
...
mod tests {
    ...
    use elide_core::mle::evaluate::evaluate_slice;
    use elide_core::mle::fold::fold_variable_inplace;
    use elide_core::{Block128, Block256, TowerField};
    use elide_fri_binius::capsule::capsule_query_bit_location;
    use elide_fri_binius::zk_affine_code::{ZkAffineLchCode, AFFINE_CODE_MESSAGE_LEN};
    use elide_fri_binius::zk_capsule_algebra::{
    ...
    use elide_fri_binius::zk_phase_a::{
        prove_phase_a, verify_phase_a, ZkPhaseARoundProof, PHASE_A_ORACLE_LEN,
    };
    use elide_gkr::layers::evaluate_permutation;
    use elide_gkr::zk_auth_capsule::{
    ...
    use elide_gkr::zk_mlecheck::ZkMleCheckRoundProof;
    use elide_ivc_core::deep_chain::capsule_leaf::{flat_c1_capsule_leaf_hash, C1CapsuleLeafKind};
    use elide_ivc_core::deep_chain::schedule::LaneSource;
    use elide_ivc_core::field_r1cs::FieldR1cs;
    use elide_poseidon2b::native::domain::{capacity_iv, TAG_ADDRFIX};
