...
//!
//! Line-by-line transliterations of `elide_ivc_core::deep_chain`:
...
use elide_ivc_core::deep_chain::c1::C1MultiDeepChainWalkProof;
use elide_ivc_core::deep_chain::relations::c1::{
...
use elide_ivc_core::deep_chain::schedule::flat_of_tower_u128;
...
mod tests {
    ...
    fn c1_ragged_walk_twin_lockstep_rows_and_mutations() {
        use elide_ivc_core::deep_chain::c1::{prove_ragged_deep_chain_walk, C1LaneClaimGroup};
        ...
        let mut channel = elide_ivc_core::field_circuit::FsChannelUnionRecorder::new_c1(
    ...
    fn c1_relation_and_shift_twins_lockstep_rows_and_mutations() {
        ...
        use elide_ivc_core::deep_chain::relations::RelationColumns;
        ...
        let mut builder = FieldR1csBuilder::new();
        let mut channel =
            elide_ivc_core::field_circuit::FsChannelUnionRecorder::new_c1(b"c1-relation-shift-twin");
    ...
    fn fixed_pattern_twin_lockstep_and_mutations() {
        ...
        let terms = vec![
            elide_ivc_core::deep_chain::relations::RelationTerm {
                coeff: F128::ONE,
    ...
    fn weighted_sum_source_binding_twin() {
        use elide_ivc_core::deep_chain::encode_kernel::source_weight_at;
        use elide_ivc_core::deep_chain::relations::prove_weighted_sum;
