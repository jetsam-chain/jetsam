//! Trace twin of `elide_ivc_core::matrix_claim::verify_matrix_claim_fold`
...
use elide_ivc_core::matrix_claim::c1::{C1MatrixAccClaim, C1MatrixFoldProof};
use elide_ivc_core::matrix_claim::MatrixFoldProof;
...
impl MatrixAccClaimTrace {
    pub fn alloc(
        ...
        native: &elide_ivc_core::matrix_claim::MatrixAccClaim,
    ) -> Self {
        Self {
            point: native
                .point
