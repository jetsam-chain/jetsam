...
impl ShapeClass {
    ...
    pub fn for_page_count(page_count: usize) -> Option<Self> {
        Some(Self {
            tier: elide_chain::consensus::params::block_page_class_tier(page_count)?,
        })
    }

    /// Class live-input capacity used by spend-facing structures.
    pub fn spend_capacity(self) -> usize {
        elide_chain::consensus::params::block_class_spend_capacity(self.tier)
    }
    ...
    pub fn touched_capacity(self) -> usize {
        self.spend_capacity() + self.tier * elide_tx::TX_OUTPUTS + 1
    }
    ...
    pub fn segment_capacity(self) -> usize {
        self.touched_capacity()
            .min(elide_chain::consensus::params::BLOCK_MAX_DISTINCT_SEGMENTS)
    }
    ...
    pub fn action_candidate_capacity(self) -> usize {
        self.tier * elide_tx::TX_ACTIONS + 3
    }
    ...
    pub fn frontier_sibling_capacity(self) -> usize {
        elide_chain::sparse_merkle::maximum_sibling_count_with_segment_cap(
            self.touched_capacity(),
            elide_gkr::MAX_MERKLE_DEPTH as u32,
            elide_chain::consensus::params::LOG_SEGMENT_SIZE,
            elide_chain::consensus::params::BLOCK_MAX_DISTINCT_SEGMENTS,
        )
    }
    ...
    pub fn shape_digest(self) -> [u8; 32] {
        let fields = [
            ...
            elide_tx::TX_INPUTS,
            elide_tx::TX_OUTPUTS,
            elide_tx::body_hash::BODY_HASH_LEAVES,
            elide_gkr::N_SPINE_SLOTS,
            elide_chain::tx_tree::TX_TREE_DEPTH,
        ];
...
mod tests {
    ...
    fn class_table_is_finite_and_injective() {
        ...
        assert_eq!(
            ...
            elide_chain::consensus::params::BLOCK_MAX_LIVE_INPUTS
        );
        assert_eq!(
        ...
        assert_eq!(elide_tx::body_hash::BODY_HASH_LEAVES, 16);
        assert_eq!(elide_gkr::N_SPINE_SLOTS, 31);
    }
