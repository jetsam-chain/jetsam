...
use elide_ivc_core::pcs::basefold::{C1QueryOpening, C1RoundMessage};
...
use elide_ivc_core::proof::{C1FieldR1csProof, FieldShape};
...
fn decode_field_proof(
    ...
    let skip = 1usize << shape.k_skip;
    let zerocheck = elide_ivc_core::zerocheck::field_c1::C1ZerocheckProof {
    ...
    let lincheck = elide_ivc_core::lincheck::c1::C1LincheckProof {
