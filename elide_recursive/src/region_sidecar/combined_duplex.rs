...
use elide_ivc_core::field_circuit::FsChannelOps;
use elide_ivc_core::pcs::{C1QuirkyDirectClaim, QuirkyDirectClaim};
use elide_ivc_core::public_io::WitnessSlice;
use elide_ivc_core::verifier::FieldPostCommitVerifierContext;
use elide_ivc_prover::field_prover::FieldPostCommitProverContext;
...
const COMBINED_DUPLEX_LAYOUT_DIGEST_DOMAIN: &[u8] =
    b"ELD/REGION-SIDECAR/COMBINED-DUPLEX-LAYOUT/V1";
const COMBINED_DUPLEX_VK_DIGEST_DOMAIN: &[u8] = b"ELD/REGION-SIDECAR/COMBINED-DUPLEX-VK/V1";
...
pub(in crate::region_sidecar) mod tests {
    ...
    use elide_ivc_core::deep_chain::schedule::{carry_selection_terms, TranscriptOp};
    ...
    fn combined_descriptor_preflight_is_checked_and_bounded() {
        assert_eq!(
            (2 * elide_ivc_core::pcs::basefold::default_fri_queries(17, 1))
                .next_power_of_two()
