...
use elide_ivc_core::deep_chain::c1::C1LaneClaimGroup;
...
use elide_ivc_core::deep_chain::relations::{claimed_refs, ColRef, FixedPattern};
use elide_ivc_core::deep_chain::schedule::{
    carry_selection_terms, flat_of_tower_u128, DuplexLayout, LaneSource,
};
use elide_ivc_core::deep_chain::source_tree::SourceTreeRefs;
...
use elide_ivc_core::pcs::{C1QuirkyDirectClaim, QuirkyDirectClaim};
...
pub(in crate::region_sidecar) mod tests {
    ...
    use elide_ivc_core::deep_chain::leaf_hash::build_sponge_leaf_columns;
    use elide_ivc_core::deep_chain::relations::{
        prove_column_relation, verify_column_relation, RelationColumns,
    };
    use elide_ivc_core::deep_chain::schedule::carry_selection_terms;
    use elide_ivc_core::deep_chain::source_tree::run_perm;
    use elide_ivc_core::deep_chain::spine::{build_spine_instance_columns, SpineInstanceFlat};
    ...
    use elide_ivc_core::pcs::{self, Commitment, PcsParams};
    use elide_ivc_core::proof::{FieldR1csProof, FieldShape};
