...
use elide_ivc_core::deep_chain::relations::{claimed_refs, ColRef, FixedPattern, RelationTerm};
use elide_ivc_core::deep_chain::schedule::{carry_selection_terms, merkle_booleanity_terms};
...
fn verify_claim_pass_trace<C: FsChannelOps>(
    ...
    values: &[LinExpr],
    point: &[LinExpr],
    native_shifts: &[elide_ivc_core::deep_chain::relations::ShiftDischargeProof],
