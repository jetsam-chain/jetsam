...
pub(crate) fn row_ledger_mark(
    builder: &elide_ivc_core::field_circuit::FieldR1csBuilder,
    last: &mut usize,
    label: &str,
) {
...
pub(crate) fn expand_empty_field_tail(
    mut r1cs: elide_ivc_core::field_r1cs::FieldR1cs,
    mut witness: Vec<elide_ivc_core::field::F128>,
    shape: elide_ivc_core::proof::FieldShape,
) -> (
    elide_ivc_core::field_r1cs::FieldR1cs,
    Vec<elide_ivc_core::field::F128>,
) {
    ...
    let expand = |matrix: &mut elide_ivc_core::field_r1cs::SparseFieldMatrix| {
