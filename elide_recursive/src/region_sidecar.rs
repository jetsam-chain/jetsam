...
use elide_ivc_core::deep_chain::ff_merkle::{ff_merkle_fixed_patterns, FfMerklePathFamily};
use elide_ivc_core::deep_chain::relations::FixedPattern;
...
const DUPLEX_LAYOUT_DIGEST_DOMAIN: &[u8] = b"ELD/REGION-SIDECAR/DUPLEX-LAYOUT/V1";
const DUPLEX_VK_DIGEST_DOMAIN: &[u8] = b"ELD/REGION-SIDECAR/DUPLEX-VK/V1";
const DUPLEX_SIDECAR_TRANSCRIPT_LABEL: &[u8] = b"history-region-sidecar-duplex-v1";
const MERKLE_LAYOUT_DIGEST_DOMAIN: &[u8] = b"ELD/REGION-SIDECAR/MERKLE-LAYOUT/V1";
const MERKLE_VK_DIGEST_DOMAIN: &[u8] = b"ELD/REGION-SIDECAR/MERKLE-VK/V1";
...
mod tests {
    ...
    use elide_ivc_core::field_circuit::FieldR1csBuilder;
    ...
    fn strided_feed_forward_ten_plus_six_matches_dense_wallet_layout_end_to_end() {
        ...
        let mut place = |columns: &elide_ivc_core::deep_chain::ff_merkle::FfMerklePathColumns,
                         depth: usize,
                         source_stride: usize,
