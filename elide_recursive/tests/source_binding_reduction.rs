...
use elide_fri::code::{Code, LOG_RATE};
use elide_ivc_core::challenger::{Challenger, FsLaneChallenger};
use elide_ivc_core::deep_chain::encode_kernel::{encode_mle_via_kernel, eq_at, source_weight_at};
use elide_ivc_core::deep_chain::relations::{prove_weighted_sum, verify_weighted_sum};
...
fn sb1_2_code_tree_binds_encode_reduction() {
    use elide_fri::merkle::MerkleTree;
    use elide_ivc_core::deep_chain::source_tree::{build_source_tree_columns, SourceTree};
    use elide_poseidon2b::hasher::CryptographicHasher;
    use elide_poseidon2b::Poseidon2bSponge;
