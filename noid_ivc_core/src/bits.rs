...
///
/// Shared by the lincheck byte-stripe builder and the PCS ring-switch
/// `fold_1b` kernels ([`crate::pcs::ring_switch`]).
#[inline(always)]
...
/// lincheck byte-stripe builder and the core R1CS matrix-apply
/// ([`crate::r1cs`]).
///
