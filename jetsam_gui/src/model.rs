...
/// `JTM` suffix so views can retain it unconditionally at every window size.
...
mod tests {
    ...
    fn trims_only_insignificant_reward_decimals() {
        assert_eq!(format_microjetsam_trimmed(50_000_000), "50");
        assert_eq!(format_microjetsam_trimmed(12_500_000), "12.5");
        assert_eq!(format_microjetsam_trimmed(3_125_000), "3.125");
        assert_eq!(format_microjetsam_trimmed(1_562_500), "1.5625");
        assert_eq!(format_microjetsam_trimmed(1_000_001), "1.000001");
    }
