...
pub const HISTORY_STEP_PACK_LEAF_HASH_DOMAIN: &[u8] = b"JTM/HISTORY-STEP/PACK-LEAF/V1";
pub const HISTORY_STEP_RUNTIME_METADATA_DIGEST_DOMAIN: &[u8] =
    b"JTM/HISTORY-STEP/RUNTIME-METADATA/V1";
...
const HISTORY_STEP_RUNTIME_METADATA_MAGIC: [u8; 16] = *b"JETSAM/HSTEP/V1\0";
