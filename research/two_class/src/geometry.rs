...
pub use jetsam_chain::consensus::paged_spend::BlockProofClass as ProofClass;

pub const BLOCK_TARGET_SECONDS: usize = jetsam_chain::consensus::params::BLOCK_TIME as usize;
...
pub const B25_ACTION_CANDIDATES: usize = B25_PAGE_CAPACITY * jetsam_tx::TX_ACTIONS + 1;
...
pub const B255_ACTION_CANDIDATES: usize = B255_PAGE_CAPACITY * jetsam_tx::TX_ACTIONS + 1;
...
pub const LOGICAL_PAGE_CAPACITY: usize = jetsam_tx::MAX_PAGED_SPEND_PAGES;
pub const LOGICAL_INPUT_CAPACITY: usize = jetsam_tx::MAX_PAGED_SPEND_INPUTS;
pub const LOGICAL_OUTPUT_CAPACITY: usize = jetsam_tx::MAX_PAGED_SPEND_OUTPUTS;
