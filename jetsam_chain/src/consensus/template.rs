...
use jetsam_tx::{PagedSpendFacts, Transaction};
...
fn build_block_template_with_post_state(
    ...
    use jetsam_tx::{TxBody, TxInput, TxOutput, TX_INPUTS};
    ...
    let development_payout = allocation.payout_each.map(|amount| {
        ...
        Transaction::new(TxBody {
            ...
            validity_bitmap: jetsam_tx::output_bitmap_bit(0) | jetsam_tx::output_bitmap_bit(1),
            is_coinbase: true,
        })
    });
