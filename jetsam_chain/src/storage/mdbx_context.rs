...
///
/// `jetsam_chain` resolves the canonical headers the native verifier must bind
...
mod tests {
    ...
    fn test_next_bundle_for_miner(
        ...
        let (template, _) = crate::consensus::template::build_node_owned_block_template(
            ...
            &finalized_active_counts,
            Vec::new(),
            jetsam_poseidon2b::primitives::Address([miner_byte; 32]),
            timestamp,
            target,
        )
        .unwrap();
    ...
    fn test_context_with_log(path: &Path, log_slots: u32) -> MdbxChainContext {
        ...
        let header = BlockHeader {
            ...
            timestamp: 1_000,
            height: 0,
            miner_address: jetsam_poseidon2b::primitives::Address([0u8; 32]),
            nonce: 0,
    ...
    fn occupancy_header(height: u64, active_slot_count: u64) -> BlockHeader {
        BlockHeader {
            ...
            height,
            miner_address: jetsam_poseidon2b::primitives::Address([0x44; 32]),
            nonce: 0,
            difficulty_target: [0xff; 32],
            log_slots: 8,
            active_slot_count,
