...
use jetsam_tx::{pack_amount_creation_id, unpack_amount_creation_id};
...
use jetsam_fri::channel::Channel;
use jetsam_fri_binius::{
...
/// (see `jetsam_tx::public::PublicInputs::log_slots` and `MAX_LOG_SLOTS`),
...
///
/// Uses the compact `jetsam_fri_binius` interleaved commitment scheme for local
...
impl FriState {
    ...
    ///
    /// Uses `jetsam_fri_binius::interleaved_commit` over the three columns,
...
pub fn open_segment_at_point(
    ...
    let ntt = jetsam_core::AdditiveNTT::<Block128>::new(commit_log + jetsam_fri::code::LOG_RATE);
...
const MIN_COMMIT_LOG: usize = jetsam_fri_binius::MERKLE_CAP_DEPTH;
...
pub fn cap_to_seg_root(cap: &jetsam_fri_binius::MerkleCap) -> StateRoot {
...
pub fn cap_to_seg_root_with_depth(cap: &jetsam_fri_binius::MerkleCap, eff_log: usize) -> StateRoot {
