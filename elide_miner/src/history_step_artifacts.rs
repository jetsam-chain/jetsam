...
use elide_recursive::acceptance::history_step_bank::{
...
pub const HISTORY_STEP_PACK_LEAF_HASH_DOMAIN: &[u8] = b"ELD/HISTORY-STEP/PACK-LEAF/V1";
pub const HISTORY_STEP_RUNTIME_METADATA_DIGEST_DOMAIN: &[u8] =
    b"ELD/HISTORY-STEP/RUNTIME-METADATA/V1";
...
const HISTORY_STEP_RUNTIME_METADATA_MAGIC: [u8; 16] = *b"ELIDE/HSTEP/V1\0\0";
...
mod tests {
    ...
    fn runtime_metadata_checks_digest_and_release_pin_before_materialization() {
        ...
        body[HISTORY_STEP_RUNTIME_METADATA_MATRIX_DIGEST_BYTES] =
            elide_recursive::HISTORY_STEP_RUNTIME_PARTS_COMPACT_VERSION;
